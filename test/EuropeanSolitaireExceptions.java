...
/**
 * Checks that the proper exceptions are thrown for the constructors and methods of the
 * EuropeanSolitaireModel class.
 */
public class EuropeanSolitaireExceptions {
  //ESM Examples:
  private MarbleSolitaireModel basic = new EuropeanSolitaireModel();
  private MarbleSolitaireModel customCenter = new EuropeanSolitaireModel(2, 2);
  private MarbleSolitaireModel customSize = new EuropeanSolitaireModel(5);
  private MarbleSolitaireModel customFull = new EuropeanSolitaireModel(5, 4, 4);

  //exception should be thrown for a negative arm thickness
  @Test(expected = IllegalArgumentException.class)
  public void testConstructorException1ArgNegative() {
    MarbleSolitaireModel errBoard = new EuropeanSolitaireModel(-1);
  }

  //exception should be thrown for a zero arm thickness
  @Test(expected = IllegalArgumentException.class)
  public void testConstructorException1ArgZero() {
    MarbleSolitaireModel errBoard = new EuropeanSolitaireModel(0);
  }

  //exception should be thrown for an even arm thickness
  @Test(expected = IllegalArgumentException.class)
  public void testConstructorException1ArgEven() {
    MarbleSolitaireModel errBoard = new EuropeanSolitaireModel(2);
  }
  ...
  public void testConstructorException2ArgsTopLeft() {
    MarbleSolitaireModel errBoard = new EuropeanSolitaireModel(0, 0);
  }
  ...
  public void testConstructorException2ArgsBottomLeft() {
    MarbleSolitaireModel errBoard = new EuropeanSolitaireModel(6, 1);
  }
  ...
  public void testConstructorException2ArgsTopRight() {
    MarbleSolitaireModel errBoard = new EuropeanSolitaireModel(1, 6);
  }
  ...
  public void testConstructorException2ArgsBottomRight() {
    MarbleSolitaireModel errBoard = new EuropeanSolitaireModel(5, 6);
  }

  //exception should be thrown for negative arm thickness
  @Test(expected = IllegalArgumentException.class)
  public void testConstructorException3ArgNegative() {
    MarbleSolitaireModel errBoard = new EuropeanSolitaireModel(-3, 3, 3);
  }

  //exception should be thrown for zero arm thickness
  @Test(expected = IllegalArgumentException.class)
  public void testConstructorException3ArgZero() {
    MarbleSolitaireModel errBoard = new EuropeanSolitaireModel(0, 2, 2);
  }

  //exception should be thrown for even arm thickness
  @Test(expected = IllegalArgumentException.class)
  public void testConstructorException3ArgEven() {
    MarbleSolitaireModel errBoard = new EuropeanSolitaireModel(6, 2, 2);
  }
  ...
  public void testConstructorException3ArgTopLeft() {
    MarbleSolitaireModel errBoard = new EuropeanSolitaireModel(3, 0, 0);
  }

  //exception should be thrown if we put the center in the top-right invalid region
  @Test(expected = IllegalArgumentException.class)
  public void testConstructorException3ArgTopRight() {
    MarbleSolitaireModel errBoard = new EuropeanSolitaireModel(5, 0, 9);
  }

  //exception should be thrown if we put the center in the bottom-left invalid region
  @Test(expected = IllegalArgumentException.class)
  public void testConstructorException3ArgBottomLeft() {
    MarbleSolitaireModel errBoard = new EuropeanSolitaireModel(7, 13, 0);
  }
  ...
  public void testConstructorException3BottomRight() {
    MarbleSolitaireModel errBoard = new EuropeanSolitaireModel(3, 6, 5);
  }
  ...
  //NOTE: no way to test for only invalid middle since no such movement exists in European model
  @Test(expected = IllegalArgumentException.class)
